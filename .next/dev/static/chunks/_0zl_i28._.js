    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SopDetailPage.useEffect": ()=>{
            async function fetchSop() {
                const { data: sopData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sops").select("id, title").eq("id", sopId).single();
                if (!sopData) {
                    setSopNotFound(true);
                    setSopLoading(false);
                    return;
                }
                const { data: stepsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sop_steps").select("step_number, description, safety_warning").eq("sop_id", sopId).order("step_number");
                setSopTitle(sopData.title);
                setDbSteps((stepsData ?? []).map({
                    "SopDetailPage.useEffect.fetchSop": (s)=>({
                            number: s.step_number,
                            title: `Step ${s.step_number}`,
                            description: s.description,
                            warning: s.safety_warning ?? null
                        })
                }["SopDetailPage.useEffect.fetchSop"]));
                setSopLoading(false);
            }
            fetchSop();
        }
...
_s(SopDetailPage, "nD56WZbTpGSxey4psBrCfI7KZis=", false, function() {
    return [
...
//# sourceMappingURL=_0zl_i28._.js.map